...
Promise.all([
  faceapi.nets.faceRecognitionNet.loadFromUri('/SRI RAMA (face-recognition-attendance-system)/models'),
  faceapi.nets.faceLandmark68Net.loadFromUri('/SRI RAMA (face-recognition-attendance-system)/models'),
  faceapi.nets.ssdMobilenetv1.loadFromUri('/SRI RAMA (face-recognition-attendance-system)/models')
]).then(start)
